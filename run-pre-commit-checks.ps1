...
try {
    ...
    Write-Host "    ⚠️  dotnet format not available, skipping" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "    ⚠️  No integration tests found, skipping" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "    ⚠️  Code coverage analysis skipped" -ForegroundColor Yellow
}
