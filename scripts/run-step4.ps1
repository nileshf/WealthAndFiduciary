...
<#
.SYNOPSIS
    Run Step 4 Jira sync with environment variables loaded from .env
.DESCRIPTION
    Loads configuration from .env file and runs the Step 4 sync script
#>
...
# Run Step 4 script
Write-Host "`nRunning Step 4 Jira sync..." -ForegroundColor Cyan
