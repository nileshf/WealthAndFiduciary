...
<#
.SYNOPSIS
    Run Step 1 Jira sync with environment variables loaded from .env
.DESCRIPTION
    Loads configuration from .env file and runs the Step 1 sync script
#>
...
# Run Step 1 script
Write-Host "`nRunning Step 1 Jira sync..." -ForegroundColor Cyan
