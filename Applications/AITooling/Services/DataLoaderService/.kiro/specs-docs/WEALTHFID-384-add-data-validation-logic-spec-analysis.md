...
- **Created**: 2026-02-19T08:30:57.759+0200
- **Updated**: 2026-02-19T08:31:00.076+0200
...
/// </summary>
public record ValidateDataCommand([Required] List<DataRow> DataRows) : IRequest<ValidationResult>;

/// <summary>
/// Handler for ValidateDataCommand
/// </summary>
public class ValidateDataCommandHandler : IRequestHandler<ValidateDataCommand, ValidationResult>
{
    private readonly IValidator _validator;
    private readonly ILogger<ValidateDataCommandHandler> _logger;

    public async Task<ValidationResult> Handle(ValidateDataCommand command, CancellationToken cancellationToken)
    {
        _logger.LogInformation("Handling ValidateDataCommand");
...
*Service: DataLoaderService | Issue: WEALTHFID-384 | Date: 2026-02-19 10:30:00*
